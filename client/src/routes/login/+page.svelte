...
<div class="flex min-h-[80vh] items-center justify-center px-4">
	<div class="w-full max-w-md space-y-8 rounded-3xl border border-neutral-800 bg-neutral-900/50 p-8 backdrop-blur-xl sm:p-12">
		...
		<div class="mt-10">
			<button
				onclick={login}
				class="group flex w-full items-center justify-center gap-3 rounded-full bg-white px-6 py-3.5 text-sm font-bold text-black transition-all hover:bg-neutral-100 active:scale-[0.98]"
			>
